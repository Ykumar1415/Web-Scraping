...
const getProductURL = (product_id) =>
  `https://www.amazon.com/gp/product/ajax/ref=dp_aod_NEW_mbc?asin=${product_id}&m=&smid=&sourcecustomerorglistid=&sourcecustomerorglistitemid=&sr=&pc=dp&experienceId=aodAjaxMain`;
...
async function getPrices(product_id) {
  ...
  const pinnedShippedFrom = pinnedElement.querySelector(
    "#aod-offer-shipsFrom .a-col-right .a-size-small"
  ).textContent;
  const pinnedSoldBy = pinnedElement.querySelector(
  ...
  offerElements.forEach((offerElement) => {
    ...
    const ShippedFrom = offerElement.querySelector(
      "#aod-offer-shipsFrom .a-col-right .a-size-small"
    ).textContent;
    const SoldBy = offerElement.querySelector(
      "#aod-offer-soldBy .a-col-right .a-size-small"
    ).textContent;
